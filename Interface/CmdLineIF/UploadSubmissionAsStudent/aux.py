...
def get_infiles(protocol_data):
    return protocol_data["infiles"]


def get_outfiles(protocol_data):
    return protocol_data["outfiles"]


def get_rand_gen(protocol_data):
    return protocol_data["rand"]


def get_custom_checker(protocol_data):
    return protocol_data["cust"]


def get_header(protocol_data):
    return protocol_data["head"]


def get_footer(protocol_data):
    return protocol_data["foot"]
