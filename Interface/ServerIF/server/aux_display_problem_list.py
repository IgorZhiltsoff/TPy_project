import os
import flask
from aux_display_problem import get_path_to_problem_base, get_problem_full_name, get_back_link_html_string
...
def display_problem_list():
    ...
    back_link_html_string = get_back_link_html_string(ref='/', text='Back to main page')
