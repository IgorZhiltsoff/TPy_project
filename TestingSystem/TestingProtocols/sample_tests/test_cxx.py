...
cxx_execution_and_conversion_data_set = {
    ExecutionAndConversionData(language_data=language_data, conversion_opts=warning_opts, time_limit_seconds=0.5, memory_limit_megabytes=64)
...
time_limit = UserSubmittedData('time_limit.cpp', 5, LanguageLabel.CXX17)
memory_limit = UserSubmittedData('memory_leak.cpp', 6, LanguageLabel.CXX14)
skipped = UserSubmittedData('accepted.py', 7, LanguageLabel.PYTHON3)
...
class CXXTest(BaseTestCase):
    ...
    def test_limited_work_space(self):
        ...
        limited_work_space_time_limit = UserSubmittedData('limited_work_space/time_limit.cpp', 5, LanguageLabel.CXX17)
        limited_work_space_memory_limit = UserSubmittedData('limited_work_space/memory_leak.cpp', 6, LanguageLabel.CXX14)
        limited_work_space_skipped = UserSubmittedData('limited_work_space/accepted.py', 7, LanguageLabel.PYTHON3)
